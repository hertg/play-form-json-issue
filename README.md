# play-form-json-issue

An example project, showcasing an issue where a JSON request body with `snake_case` fields,
can't be mapped to a Java Play form with `camelCase` fields.
